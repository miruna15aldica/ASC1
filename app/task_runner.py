...
class TaskRunner(Thread):
    def __init__(self):
        ...
        # Important - daca vreau sa verific unittesturile, ma folosesc de urmatoarea baza de date
        # self.data = DataIngestor('./unittests/teste.csv').data
    ...
    def logging():
        ...
        handler = RotatingFileHandler('webserver.log', maxBytes=100000, backupCount=3)
    ...
    def states_mean(self, data: dict, question: str):
        ...
        sorted_results_dict = dict(sorted_result) 
    ...
    def state_mean(self, data: dict, question: str, state: str):
        ...
        state_mean_dict = {state : mean_value} 
